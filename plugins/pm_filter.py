...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.answer("💢 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐅𝐨𝐫𝐦𝐚𝐭 💢\n\n📎 𝐒𝐞𝐫𝐢𝐞𝐬\n• sᴇx ᴇᴅᴜᴄᴀᴛɪᴏɴ 𝟸𝟶𝟷𝟿 [𝐆𝐞𝐭 𝐅𝐮𝐥𝐥 𝐒𝐞𝐚𝐬𝐨𝐧]\n• ᴇʟɪᴛᴇ s𝟶𝟷ᴇ𝟶𝟷 [𝐄𝐩 𝐰𝐢𝐬𝐞]\n\n🎬 𝐌𝐨𝐯𝐢𝐞𝐬\n• ʟᴜᴄɪғᴇʀ\n• ᴊᴏʜɴ ᴡɪᴄᴋ 𝟸𝟶𝟷𝟺\n\n𝘐𝘧 𝘠𝘰𝘶 𝘸𝘢𝘯𝘵 𝘴𝘦𝘳𝘪𝘦𝘴 𝘰𝘳 𝘮𝘰𝘷𝘪𝘦 𝘶 𝘮𝘶𝘴𝘵 𝘧𝘰𝘭𝘭𝘰𝘸 𝘵𝘩𝘦 𝘍𝘖𝘙𝘔𝘈𝘛 𝘢𝘯𝘥 𝘙𝘶𝘭𝘦𝘴 🌚", True)
    
    elif query.data == 'tips':
        await query.answer("𝖳𝗁𝗂𝗌 𝖬𝖾𝗌𝗌𝖺𝗀𝖾 𝖶𝗂𝗅𝗅 𝖡𝖾 𝖣𝖾𝗅𝖾𝗍𝖾𝖽 𝖠𝖿𝗍𝖾𝗋 5 𝖬𝗂𝗇𝗎𝗍𝖾𝗌 𝗍𝗈 𝖯𝗋𝖾𝗏𝖾𝗇𝗍 𝖢𝗈𝗉𝗒𝗋𝗂𝗀𝗁𝗍 !\n\n𝖳𝗁𝖺𝗇𝗄 𝖸𝗈𝗎 𝖥𝗈𝗋 𝖴𝗌𝗂𝗇𝗀 𝖬𝖾 😊\n\n\n𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖡𝗒 @MalluxGram", True)

    elif query.data == "start":
        buttons = [[
                    InlineKeyboardButton('➕ 𝖠𝖽𝖽 𝖬𝖾 𝖳𝗈 𝖸𝗈𝗎𝗋 𝖦𝗋𝗈𝗎𝗉 ➕', url=f"http://t.me/{temp.U_NAME}?startgroup=true")
                ],[
                    InlineKeyboardButton('🩹 𝐀𝐝𝐦𝐢𝐧 ', callback_data="owner_info"),
